...
void main() {
  group('AppConstants', () {
    ...
    test('firebase project id should be set', () {
    ...
    test('API keys should decode correctly', () {
      expect(AppConstants.geminiApiKey, isNotEmpty);
      expect(AppConstants.groqApiKey, isNotEmpty);
      expect(AppConstants.bigModelApiKey, isNotEmpty);
    });
  });
}
